...
> **Note**: For GLTF models, see `gltf-loading-guide.md`. For game development patterns, see `game-patterns.md`. Both are accessible from the main SKILL.md reference table.
